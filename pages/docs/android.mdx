...
**Github:** [https://github.com/nrl-ai/daisykit-android](https://github.com/nrl-ai/daisykit-android).
...
```
git clone --recurse-submodules https://github.com/nrl-ai/daisykit-android.git
```

Or

```
git clone https://github.com/nrl-ai/daisykit-android.git
cd daisykit-android
git submodule update --init
```
### Step 2: Download NCNN

[https://github.com/Tencent/ncnn/releases](https://github.com/Tencent/ncnn/releases )
...
[https://github.com/nihui/opencv-mobile](https://github.com/nihui/opencv-mobile)
