---
title: Daisykit - Easy AI for Everyone
---
...
import docsCard from '../public/maxresdefault.jpg'
import docsCardDark from '../public/maxresdefault.jpg'

<div className="home-content">
  <div className="content-container">
    <h1 className="headline">Integrate AI into your project <br className='sm:block hidden'/>with Daisykit.</h1>
    <p className="subtitle">Using AI without neural network knowledge.</p>
      ...
      <Features>
        ...
        <Feature index={1} centered className="card-with-border" href="/docs">
          <div className="h-full flex flex-col justify-between">
            <h3> <span style={{ fontWeight: 300 }}>Use AI in your project</span> <br/> in just a minute.</h3>
            <p className='text-center mb-8'>With Daisykit Python:</p>
            <div>
              <div className={styles.optimization}>
                <div style={{ fontSize: '.9rem' }} className="leading-8">
                  <code>{`pip install daisykit`}</code>
                </div>
              </div>
              <p className="subtitle">
